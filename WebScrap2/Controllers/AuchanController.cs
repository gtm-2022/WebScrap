...
namespace FirstScraper.Controllers
{
    ...
    public class AuchanController : ControllerBase
    {
        ...
        [HttpGet("scrape")]
        public async Task<IActionResult> ScrapeProduct([FromQuery] string url = "https://www.auchan.fr/lego-lego-technic-42170-la-moto-kawasaki-ninja-h2r-idee-cadeau-pour-enfants-jouet-creatif/pr-C1769116")
        {

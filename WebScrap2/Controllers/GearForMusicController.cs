...
namespace FirstScraper.Controllers
{
    ...
    public class GearForMusicController : ControllerBase
    {
        ...
        [HttpGet("scrape")]
        public async Task<IActionResult> ScrapeProduct([FromQuery] string url = "https://www.gear4music.com/Guitar-and-Bass/LA-Select-Electric-Guitar-by-Gear4music-Black/64DK")
        {
